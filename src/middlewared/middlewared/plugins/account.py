...
ALTERNATE_DEFAULT_HOME_PATH = '/var/empty'
...
class UserService(CRUDService):
    ...
    def validate_homedir_path(self, verrors, schema, data, users):
        ...
        if data['home'] == DEFAULT_HOME_PATH or data['home'] == ALTERNATE_DEFAULT_HOME_PATH:
            return False
    ...
    def do_create(self, data):
        ...
        if data['home'] and data['home'] not in (DEFAULT_HOME_PATH, ALTERNATE_DEFAULT_HOME_PATH):
            try:
